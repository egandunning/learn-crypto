...
QT_MOC_LITERAL(1, 12, 14), // "show_input_box"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "ButtonArray\0show_input_box\0"
};
...
const QMetaObject ButtonArray::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ButtonArray.data,
      qt_meta_data_ButtonArray,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ButtonArray::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ButtonArray.stringdata0))
        return static_cast<void*>(const_cast< ButtonArray*>(this));
